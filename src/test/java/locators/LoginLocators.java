...
public final class LoginLocators {
    ...
    public static final By PASSWORD_FIELD = AppiumBy.xpath("//*[@name=\"login_password_field\"]");
    public static final By TOBECLEAR_PW = AppiumBy.xpath("//XCUIElementTypeSecureTextField[@name=\"login_password_field\"]");
    public static final By LOGIN_BTN_IOS = AppiumBy.accessibilityId("login_button");
    public static final By LOGIN_BTN_DIS = AppiumBy.xpath("//XCUIElementTypeButton[@name=\"login_button\"]");
    ...
    public static final By REGISTER_BTN = AppiumBy.accessibilityId("login_registration_popup_register_button");
    ...
    public static final By FORGOT_PASS_FIELD = AppiumBy.xpath("//XCUIElementTypeTextField[@name=\"forgot_password_email_or_num_field\"]\n");
    ...
    public static final By ERR_INCORRECT_CREDS = AppiumBy.accessibilityId("login_error_message");
    ...
    public static Map<String, By> getBasicLocators() {
        ...
        locators.put("Login Button", LOGIN_BTN_IOS);
