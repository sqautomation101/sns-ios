...
@CucumberOptions(
        features = "src/test/resources/features/BottomNav.feature",   // path to your .feature files
        glue = {"stepdefinitions", "hooks"},        // step definitions + hooks
        plugin = {"pretty",
                "json:target/cucumber-json/initial/bottomnav.json", //Machine-readable, for merging reports, rerun handling, and CI dashboards.
